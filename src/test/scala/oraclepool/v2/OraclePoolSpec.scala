...
//import oraclepool.v2.Contracts
...
//
//      val poolBootStrapTx: SignedTransaction = TxUtil.createTx(
//        Array(customInputBox),
//        Array[InputBox](),
...
//        Array(epochPrepBox, customInputBox),
//        Array[InputBox](),
//        Array(liveEpochBoxToCreate),
//        fee,
//        changeAddress,
//        Array[String](),
//        Array[DhtData](),
...
//        TxUtil.createTx(Array(customInputBox), Array[InputBox](), Array(oracle1Box), fee, changeAddress, Array[String](), Array[DhtData](), false)
//      val oracleBox1ToSpend = bootStrapOracle1Tx.getOutputsToSpend.get(0)
//
//      val bootStrapOracle2Tx =
//        TxUtil.createTx(Array(customInputBox), Array[InputBox](), Array(oracle2Box), fee, changeAddress, Array[String](), Array[DhtData](), false)
//      val oracleBox2ToSpend = bootStrapOracle2Tx.getOutputsToSpend.get(0)
//
//      val bootStrapOracle3Tx =
//        TxUtil.createTx(Array(customInputBox), Array[InputBox](), Array(oracle3Box), fee, changeAddress, Array[String](), Array[DhtData](), false)
//      val oracleBox3ToSpend = bootStrapOracle3Tx.getOutputsToSpend.get(0)
//
//      val bootStrapOracle4Tx =
//        TxUtil.createTx(Array(customInputBox), Array[InputBox](), Array(oracle4Box), fee, changeAddress, Array[String](), Array[DhtData](), false)
