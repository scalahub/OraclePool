package oraclepool.v2a.helpers
...
import oraclepool.v2a.{Contracts, OraclePool}
...
trait MockHelpers {
  ...
  def bootstrapPoolBox(customCreationHeight: Int, rate: Long, counter: Int = 0, newPoolNFT: Option[String] = None, optRewardTokenQty: Option[Long] = None, optRewardTokenId: Option[String] = None)(
      implicit ctx: BlockchainContext) =
    TxUtil
      .createTx(
        Array(
        ...
        Array(
          KioskBox(
            ...
            tokens = Array(
              ...
              (optRewardTokenId.getOrElse(rewardTokenId), optRewardTokenQty.getOrElse(1000000L))
            ),
  ...
  def transferOracleBox(inputOracleBox: InputBox, privKey: BigInt, newPubKey: Option[KioskGroupElement], rewardTokenQty: Long, customRewardTokenId: Option[String] = None)(
      implicit ctx: BlockchainContext) =
    TxUtil
      .createTx(
        ...
        Array(
          KioskBox(
            ...
            tokens = getOracleTokensToAdd(rewardTokenQty, customRewardTokenId) // at least one reward token has to be transferred
          )
        ),
        1500000,
        changeAddress,
  ...
  def voteForUpdate(votedValue: Array[Byte],
                    ...
                    contextVarOutIndex: Int,
                    newPubKey: Option[KioskGroupElement] = None,
                    optBallotTokenId: Option[String] = None,
        ...
        Array(
          KioskBox(
            ...
            registers = Array(
              ...
              KioskCollByte(optRewardTokenId.getOrElse(rewardTokenId).decodeHex),
              KioskLong(optRewardTokenAmt.getOrElse(1000000L))
            ),
