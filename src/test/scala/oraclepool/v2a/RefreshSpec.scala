  ...
  property("Refresh pool box v2") {
    createMockedErgoClient(MockData(Nil, Nil)).execute { implicit ctx: BlockchainContext =>
      ...
      noException should be thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 10))),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(junkAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 10))),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((junkTokenId, 1), (rewardTokenId, 1000000L - 10))),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(junkAddress, minStorageRent, Array(KioskLong(1002), KioskInt(0) /* wrong counter, should be 1 */ ), Array((poolNFT, 1), (rewardTokenId, 1000000L - 10))),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        Array(
          ...
          dataPoint2.withContextVars(new ContextVar(0, KioskInt(4).getErgoValue)), // ...
          dataPoint3.withContextVars(new ContextVar(0, KioskInt(3).getErgoValue)),
          dataPoint5.withContextVars(new ContextVar(0, KioskInt(2).getErgoValue)), // dataPoint5 should come last as per sorting
          dataPoint4.withContextVars(new ContextVar(0, KioskInt(6).getErgoValue)),
          dummyFundingBox
        ),
        Array.empty,
      ...
      the[AssertionError] thrownBy TxUtil.createTx(
        Array(
          poolBox,
          refreshBox.withContextVars(new ContextVar(0, KioskInt(1).getErgoValue)), // context variable says 1st dataPoint box (dataPoint1) is spender
          dataPoint1.withContextVars(new ContextVar(0, KioskInt(5).getErgoValue)), // output index 5 corresponds to dataPoint1
          dataPoint2.withContextVars(new ContextVar(0, KioskInt(4).getErgoValue)), // ...
          dataPoint3.withContextVars(new ContextVar(0, KioskInt(3).getErgoValue)),
          dataPoint4.withContextVars(new ContextVar(0, KioskInt(6).getErgoValue)),
      ...
      noException should be thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 5))), // removed only 5 instead of 10
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey5), Array((oracleTokenId, 1), (rewardTokenId, 51))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))), // took only 1 instead of 6
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 11))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey4), Array((oracleTokenId, 1), (rewardTokenId, 41)))
        ),
      ...
      noException should be thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 10))), // removed 10,
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey5), Array((oracleTokenId, 1), (rewardTokenId, 51))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))), // took only 1, thereby burning 5
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 11))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey4), Array((oracleTokenId, 1), (rewardTokenId, 41)))
        ),
      ...
      an[Exception] should be thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 11))), // removed 11, allowed 10,
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey5), Array((oracleTokenId, 1), (rewardTokenId, 51))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
      ...
      an[AssertionError] should be thrownBy TxUtil.createTx(
        Array(
          poolBox,
          refreshBox.withContextVars(new ContextVar(0, KioskInt(0).getErgoValue)), // 1st dataPoint box (dataPoint1) is spender
          dataPoint1.withContextVars(new ContextVar(0, KioskInt(3).getErgoValue)), // wrong context variable, should be 2
          dataPoint2.withContextVars(new ContextVar(0, KioskInt(2).getErgoValue)), // wrong context variable, should be 3
          dataPoint3.withContextVars(new ContextVar(0, KioskInt(4).getErgoValue)), // output index 4 corresponds to dataPoint3
          dataPoint4.withContextVars(new ContextVar(0, KioskInt(5).getErgoValue)), // output index 5 corresponds to dataPoint4
          dataPoint5.withContextVars(new ContextVar(0, KioskInt(6).getErgoValue)), // output index 6 corresponds to dataPoint5
          dummyFundingBox
      ...
      an[AssertionError] should be thrownBy TxUtil.createTx(
        ...
        Array(
          ...
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 20))), // didn't increment token, should have been 21
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey4), Array((oracleTokenId, 1), (rewardTokenId, 41))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey5), Array((oracleTokenId, 1), (rewardTokenId, 51)))
        ),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1003 /* wrong average, should be 1002 */ ), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 10))),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        Array(
          poolBox,
          refreshBox.withContextVars(new ContextVar(0, KioskInt(0).getErgoValue)), // 1st dataPoint box (dataPoint1) is spender
          createDataPoint(1000, 1 /* should be 0 */, oracleAddress, minStorageRent, oracleBox1, privKey1, 0, 10)
            .withContextVars(new ContextVar(0, KioskInt(2).getErgoValue)), // output index 2 corresponds to dataPoint1
          createDataPoint(1001, 1 /* should be 0 */, oracleAddress, minStorageRent, oracleBox2, privKey2, 0, 20)
            .withContextVars(new ContextVar(0, KioskInt(3).getErgoValue)), // output index 3 corresponds to dataPoint2
          dataPoint3.withContextVars(new ContextVar(0, KioskInt(4).getErgoValue)), // output index 4 corresponds to dataPoint3
          dataPoint4.withContextVars(new ContextVar(0, KioskInt(5).getErgoValue)), // output index 5 corresponds to dataPoint4
          dataPoint5.withContextVars(new ContextVar(0, KioskInt(6).getErgoValue)), // output index 6 corresponds to dataPoint5
      ...
      the[Exception] thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong(1001), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 6))),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
      ...
      the[Exception] thrownBy {
        ...
        TxUtil.createTx(
          ...
          Array.empty,
          Array(
            KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((newPoolNFT, 1), (rewardTokenId, 1000000L - 10))),
            KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
      ...
      noException should be thrownBy TxUtil.createTx(
        ...
        Array.empty,
        Array(
          KioskBox(poolAddress, minStorageRent, Array(KioskLong((1000 + 1001 + 1002 + 1003) / 4), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 8))),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
      ...
      the[Exception] thrownBy TxUtil.createTx(
        ...
        Array(
          KioskBox(
            poolAddress,
            minStorageRent,
            Array(KioskLong((1000 + 1001 + 1002 + 1003) / 4), KioskInt(1)),
            Array((poolNFT, 1), (rewardTokenId, 1000000L - 8)),
            creationHeight = Some(ctx.getHeight - buffer - 1)
          ),
          KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 15))),
          KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
      ...
      an[Exception] should be thrownBy
        TxUtil.createTx(
          ...
          Array.empty,
          Array(
            KioskBox(poolAddress, minStorageRent, Array(KioskLong((1000 + 1001 + 1002 + 1003) / 4), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 8), (junkTokenId, 1))),
            KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 15))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
      ...
      the[Exception] thrownBy {
        ...
        TxUtil.createTx(
          ...
          Array.empty,
          Array(
            KioskBox(poolAddress, minStorageRent, Array(KioskLong(1002), KioskInt(1)), Array((poolNFT, 1), (rewardTokenId, 1000000L - 10)), creationHeight = Some(thisEpochStart)),
            KioskBox(refreshAddress, minStorageRent, Array.empty, Array((refreshNFT, 1))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey1), Array((oracleTokenId, 1), (rewardTokenId, 16))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey2), Array((oracleTokenId, 1), (rewardTokenId, 21))),
            KioskBox(oracleAddress, minStorageRent, Array(pubKey3), Array((oracleTokenId, 1), (rewardTokenId, 31))),
