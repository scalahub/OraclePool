...
class AddressSpec extends PropSpec with Matchers {
  ...
  property("Display Addresses") {
    ...
    Blake2b256(epochPrepErgoTree.bytes).encodeHex shouldEqual "1ea26a2c2f6c418e9045aa5fcf82ac7cb1a6abffe8e6da98a855fc1a88d5705c"
    Blake2b256(liveEpochErgoTree.bytes).encodeHex shouldEqual "0e0815adc48307f2376afd4dbfb1b4c51ba204bf5fee97f84834db278514df7b"
